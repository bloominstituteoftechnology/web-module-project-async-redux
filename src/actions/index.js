...
export const GET_CARDS_START = 'GIT_CARDS_START'
export const GET_CARDS_SUCCESS = 'IT_CARDS_SUCCESS'
export const GET_CARDS_FAILURE = 'GIT_CARDS_FAILURE'
export const LOAD_CARDS_START = 'LOAD_CARDS_START'
export const FIVE_CARDS = 'FIVE_CARDS'
export const SET_CURRENT_CARD = 'SET_CURRENT_CARD'
export const getCards = () => dispatch => {
    dispatch ({type: GIT_CARDS_START})
