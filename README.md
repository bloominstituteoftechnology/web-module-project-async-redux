...
- [x] Build Redux onto src/index
- [x]Compose file tree: reducers, actions, store
- [x] connect state to initial App
- [x] render state object
- [x] build async actions
- [x] integrate actions/cases
- [x] loading, error, resets
